...
import java.io.*;
	...
	public class Graph_M 
	{
		...
		{
			System.out.println("\t Indore Metro Map");
			System.out.println("\t------------------");
			System.out.println("----------------------------------------------------\n");
			ArrayList<String> keys = new ArrayList<>(vtces.keySet());
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			g.addVertex("Rajiv Gandhi Square");
			g.addVertex("Mata Gujari");
			g.addVertex("Vishnupuri");
			g.addVertex("Bhawarkuan Square");
			g.addVertex("Holkar Subway");
			g.addVertex("Navlakha Chouraha");
			g.addVertex("Indira Pratima");
			g.addVertex("GPO");
			g.addVertex("Shivaji Vatika");
			g.addVertex("AICTSL");
			g.addVertex("Geeta Bhawan Square");
			g.addVertex("Palasia");
			g.addVertex("Industry House");
			g.addVertex("L I G Square");
			g.addVertex("Press Complex");
			g.addVertex("MR 9 Square");
			g.addVertex("Vijay Nagar");
			g.addVertex("Satya Sai Square");
			g.addVertex("Shalimar Township");
			g.addVertex("Niranjanpur");
			
			g.addEdge("Rajiv Gandhi Square", "Mata Gujari", 3);
			g.addEdge("Mata Gujari", "Vishnupuri", 1);
			g.addEdge("Vishnupuri", "Bhawarkuan Square", 2);
			g.addEdge("Bhawarkuan Square", "Holkar Subway", 2);
			g.addEdge("Holkar Subway", "Navlakha Chouraha", 3);
			g.addEdge("Navlakha Chouraha", "Indira Pratima", 4);
			g.addEdge("Indira Pratima", "GPO", 3);
			g.addEdge("GPO", "Shivaji Vatika", 2);
			g.addEdge("Shivaji Vatika", "AICTSL", 2);
			g.addEdge("AICTSL", "Geeta Bhawan Square", 2);
			g.addEdge("Geeta Bhawan Square", "Palasia", 1);
			g.addEdge("Palasia", "Industry House", 2);
			g.addEdge("Industry House", "L I G Square", 3);
			g.addEdge("L I G Square", "Press Complex", 2);
			g.addEdge("Press Complex", "MR 9 Square", 2);
			g.addEdge("MR 9 Square", "Vijay Nagar", 1);
			g.addEdge("Vijay Nagar", "Satya Sai Square", 2);
			g.addEdge("Satya Sai Square", "Shalimar Township", 2);
			g.addEdge("Shalimar Township", "Niranjanpur", 1);
		}
